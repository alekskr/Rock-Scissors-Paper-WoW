...
"}")
        ...
        self.label_title.setStyleSheet(u"/*color: rgb(255, 126, 195);*/\n"
...
"	background-color: qlineargradient(spread:pad, x1:0, y1:0.489, x2:1, y2:0.528, stop:0 rgba(69, 147, 32), stop:1 rgba(127, 253, 49));\n"
"}\n"
"")
...
"color: rgb(127, 253, 49)")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>WELCOME</p></body></html>", None))
